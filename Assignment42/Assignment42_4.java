/*
    Problem Statement : 4. Write Java program which accept two arrays from user and form new array which is combination
                             of contents of first and second array.
*/
import java.util.*;
...
class Assignment42_4
{
    public static void main(String Arg[])
    {
        ...
        obj.Accept();
        obj.Display();
        int ArrRet[] = obj.ConcateArray();

        System.out.println("Updated Array After Concate : ");
